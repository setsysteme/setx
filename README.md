...
You can then execute your native executable with: `./target/setx-1.0.0-SNAPSHOT-runner`
...
- Playwright ([guide](https://docs.quarkiverse.io/quarkus-playwright/dev/)): Playwright is an open-source automation library for end-to-end browser testing and web scraping.
